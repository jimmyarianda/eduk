...
<ol class="breadcrumb mb-4">
    ...
    <li class="breadcrumb-item"><a href="<?= site_url('admin/user'); ?>">Data User</a></li>
...
<div class="card card-default">
    ...
    <div class="card-header">Tambah Data User
        &nbsp;&nbsp;&nbsp;<a class="btn btn-primary btn-sm" href="<?= site_url('admin/user'); ?>"><i class="fas fa-arrow-left"></i>Kembali</a>
    ...
    <div class="card-footer">
        ...
        <a class="btn btn-primary" href="<?= site_url('admin/user'); ?>">Batal</a>
    </div>
    </form>
</div>