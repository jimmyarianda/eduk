...
class Jabatancatatan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['content'] = 'vuser/jabatancatatan';
            ...
            $columns = array(
                ...
                array(
                    'db' => 'jct_skjabatan', 'dt' => 'jct_skjabatan', 'formatter' => function ($jabatanct) {
                        return '<a href="' . site_url('user/jabatancatatan/download_file/' . $jabatanct) . '" class="btn btn-warning btn-sm mb-1"><i class="fas fa-download"></i>Download</a>';
                    }
                ),
