...
class Pangkatcatatan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['content'] = 'vuser/pangkatcatatan';
            ...
            $columns = array(
                ...
                array(
                    'db' => 'pct_skpangkat', 'dt' => 'pct_skpangkat', 'formatter' => function ($pangkatct) {
                        return '<a href="' . site_url('user/pangkatcatatan/download_file/' . $pangkatct) . '" class="btn btn-warning btn-sm mb-1"><i class="fas fa-download"></i>Download</a>';
                    }
                ),
