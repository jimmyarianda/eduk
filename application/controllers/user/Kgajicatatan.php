...
class Kgajicatatan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['content'] = 'vuser/kgajicatatan';
            ...
            $columns = array(
                ...
                array(
                    'db' => 'gct_skkenaikangaji', 'dt' => 'gct_skkenaikangaji', 'formatter' => function ($kgajictt) {
                        return '<a href="' . site_url('user/kgajicatatan/download_file/' . $kgajictt) . '" class="btn btn-warning btn-sm mb-1"><i class="fas fa-download"></i>Download</a>';
                    }
                ),
