...
class Pendidikan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['content'] = 'vadmin/pendidikan';
            ...
            $columns = array(
                ...
                array(
                    'db' => 'pd_ijazah', 'dt' => 'pd_ijazah', 'formatter' => function ($ijazah) {
                        return '<a href="' . site_url('admin/pendidikan/download_file/' . $ijazah) . '" class="btn btn-warning btn-sm mb-1"><i class="fas fa-download"></i>Download</a>';
                    }
                ),
                array(
                    'db' => 'pd_id',
                    ...
                    'formatter' => function ($id) {
                        return '<a href="' . site_url('admin/pendidikan/edit/' . $id) . '" class="btn btn-success btn-sm mb-1"><i class="fas fa-edit"></i></a>
                                <a onclick="deleteConfirm(' . "'" . site_url('admin/pendidikan/delete/' . $id) . "'" . ')" href="#!" class="btn btn-danger btn-sm mb-1"><i class="fas fa-trash"></i></a>';
                    }
                )
            );
    ...
    public function add()
    {
        if (isset($_POST['simpan'])) {
            ...
            $data['content'] = 'vadmin/pendidikan_form';
            $this->load->view('vadmin/index', $data);
        }
    }
    ...
    public function edit()
    {
        ...
        if (isset($_POST['simpan'])) {
            ...
            $data['content'] = 'vadmin/pendidikan_edit_form';
