...
class Pelatihan extends CI_Controller
{
            ...
            $columns = array(
                ...
                array(
                    'db' => 'plt_sertifikat', 'dt' => 'plt_sertifikat', 'formatter' => function ($sertifikat) {
                        return '<a href="' . site_url('admin/pelatihan/download_file/' . $sertifikat) . '" class="btn btn-warning btn-sm mb-1"><i class="fas fa-download"></i>Download</a>';
                    }
                ),
                array(
                    'db' => 'plt_id',
                    ...
                    'formatter' => function ($id) {
                        return '<a href="' . site_url('admin/pelatihan/edit/' . $id) . '" class="btn btn-success btn-sm mb-1"><i class="fas fa-edit"></i></a>
                                <a onclick="deleteConfirm(' . "'" . site_url('admin/pelatihan/delete/' . $id) . "'" . ')" href="#!" class="btn btn-danger btn-sm mb-1"><i class="fas fa-trash"></i></a>';
                    }
                )
            );
    ...
    public function add()
    {
        if (isset($_POST['simpan'])) {
            ...
            $data['content'] = 'vadmin/pelatihan_form';
            $this->load->view('vadmin/index', $data);
        }
    }
    ...
    public function edit()
    {
        ...
        if (isset($_POST['simpan'])) {
            ...
            $data['content'] = 'vadmin/pelatihan_edit_form';
