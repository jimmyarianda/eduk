...
class Lampirancatatan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['content'] = 'vadmin/lampirancatatan';
            ...
            $columns = array(
                ...
                array(
                    'db' => 'lam_dokumen', 'dt' => 'lam_dokumen', 'formatter' => function ($dokumenct) {
                        return '<a href="' . site_url('admin/lampirancatatan/download_file/' . $dokumenct) . '" class="btn btn-warning btn-sm mb-1"><i class="fas fa-download"></i>Download</a>';
                    }
                ),
                array(
                    'db' => 'lam_id',
